    ...
    schema = vol.Schema(
        {
            ...
            # vol.Optional(
            #     CONF_DEVICE_ASSOCIATION,
            #     default=user_input.get(
            #         CONF_DEVICE_ASSOCIATION,
            #         fallback.get(CONF_DEVICE_ASSOCIATION, DEFAULT_DEVICE_ASSOCIATION),
            #     ),
            # ): selector.SelectSelector(
            #     selector.SelectSelectorConfig(
            #         options=["no_device", "own_device", "another_device"],
            #         translation_key=CONF_DEVICE_ASSOCIATION,
            #         multiple=False,
            #         custom_value=False,
            #         mode=selector.SelectSelectorMode.LIST,
            #     )
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            if yaml_switch:
                ...
                user_input[CONF_ID_TOKEN] = slugify(user_input.get(CONF_NAME))
